...
from amjuLoans.email_settings import EMAIL_HOST, EMAIL_PORT, EMAIL_HOST_PASSWORD
from amjuLoans.utils import unique_key_generator, get_trial_days, unique_slug_generator_by_email, \
